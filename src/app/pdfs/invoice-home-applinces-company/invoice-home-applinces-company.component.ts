...
@Component({
  selector: 'app-invoice-home-applinces-company',
  templateUrl: './invoice-home-applinces-company.component.html',
  styleUrl: './invoice-home-applinces-company.component.css'
})
export class InvoiceHomeApplincesCompanyComponent {
  loanDetails:any;
  shopDetails:any;
  invoice:any;
  cgst:any;
